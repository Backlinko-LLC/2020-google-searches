...
An alternative visualization of the same data by grouped category in a violin plot The bar shows the median cpc value by difficulty.

```{r difficulty_cpc_violin_true_sample_size, echo=FALSE}
knitr::include_graphics(here::here("plots", "reworked", "cpc_difficulty_true.png"))
```
