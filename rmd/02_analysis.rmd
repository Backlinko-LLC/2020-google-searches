...
knitr::opts_chunk$set(warning = F, message = F, fig.path = "../plots/", cache = T, fig.showtext = TRUE, dpi = 700)
...
volume_top %>% 
  ...
  labs(x = "", title = "Most searches have low volume", fill = "") + 
  annotate("text", x = 8800, y = 75*10^6, label = "Remaining 99.9967%") + 
...
df %>% 
  ...
  geom_bar(stat = "identity", fill = "turquoise4", color = "black") +
  theme_light() +
  labs(x = "Volume", y = "Percentage of all searches", title = "Most searches have low volume") +
