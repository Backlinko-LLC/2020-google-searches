...
!!!D: x-label is meant to say search volume instead of keyword length, right?  
...
!!!D: The info_keyword category is an interesting variable. May be we can add a plot on the total search volume by category? Fro ma practical standpoint is pretty useless, but a general overview would provide a great insight. What do you think? Any other ideas? 
