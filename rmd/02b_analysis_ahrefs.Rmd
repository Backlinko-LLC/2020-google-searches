...
!!!D: Don´t worry about the search volumes for this data set. Remember: We exported a small sample to enrich it with another tool to gain insights for additional variables that the larger data set does not provide like keyword difficulty. 
