...
```{r serp_presence_orig, fig.height = 5, fig.width = 7}
...
```{r serp_presence_repr, fig.height = 5, fig.width = 7}
...
rdffn %>% group_by(n_serp) %>%
  ...
  geom_bar(stat = "identity", fill = "turquoise4", color = "black", width = 0.8) +
  labs(x = "SERP features", title = "Number of SERP features and mean clicks", y = "Difficulty")
```
