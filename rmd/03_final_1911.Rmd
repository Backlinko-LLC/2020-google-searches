...
knitr::include_graphics(here::here("plots", "reworked_font", "proportion_searches.png"))
```

```{r volume_searches, echo=FALSE}
knitr::include_graphics(here::here("plots", "reworked_font", "proportion_search_volume.png"))
```
...
```{r}
knitr::include_graphics(here::here("plots", "reworked_font", "volume_by_searches_dataforseo.png"))
```

Or *ahref*:

```{r}
knitr::include_graphics(here::here("plots", "reworked_font", "volume_by_searches_ahref.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "questions_count.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "volume_keywordlength.png"))
```

The mean keyword length in characters is 11.2, and the median is 8.5.

```{r keyword_words_volume, echo=FALSE}
knitr::include_graphics(here::here("plots", "reworked_font", "volume_words_searchterm.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "volume_mean_category_ordered.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font","volume_total_category_ordered.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "cpc_mean_category_ordered.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "volume_difficulty.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "cpc_difficulty_boxplot.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "serp_features.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "serp_cps.png"))
```

Easy keywords have fewer SERP features.

```{r serp_difficulty_boxplot, echo=FALSE}
knitr::include_graphics(here::here("plots", "reworked_font", "serp_difficulty_box.png"))
```

Thumbnail & Top stories is the most common SERP feature pairing.

```{r serp_pairs, echo=FALSE}
knitr::include_graphics(here::here("plots", "reworked_font", "serp_pairings.png"))
```

Searches without SERP features tend to be low volume.

```{r serp_volume_ridge, echo=FALSE}
knitr::include_graphics(here::here("plots", "reworked_font", "serp_volume.png"))
```

Searches with more SERP features have higher mean difficulty.

```{r serp_difficulty_n, echo=FALSE}
knitr::include_graphics(here::here("plots", "reworked_font", "serp_mean_difficulty.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "volume_population.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "cpc_countries.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "volume_region.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "volume_region_high.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "volume_region_corr.png"))
```

*A version showing data points binned to hex tiles showing counts:*

```{r international_v_us_volume_hex, echo=FALSE}
knitr::include_graphics(here::here("plots", "reworked_font", "volume_region_corr_hex.png"))
```
...
knitr::include_graphics(here::here("plots", "reworked_font", "volume_region_cps_corr.png"))
```

They also have a higher cost-per-click on average

```{r international_cpc, echo=FALSE}
knitr::include_graphics(here::here("plots", "reworked_font", "volume_region_cpc_corr.png"))
```

Searches that have higher volume internationally, tend to have higher difficulty

```{r international_difficulty, echo=FALSE}
knitr::include_graphics(here::here("plots", "reworked_font", "volume_region_difficulty_corr.png"))
```
